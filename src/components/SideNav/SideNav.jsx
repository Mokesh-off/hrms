...
>>>>>>> develop
          ...
          <div className={this.state.showButtons} >
            ...
            <Link to='/leavelist'>
              <button ref='leavelist' className={this.state.employeeVisibility}>Leave Approval</button>
            </Link>
            <Link to='/leaverequest'>
            ...
            <Link to='/leaveRecords'>
              <button ref = 'leaveRecord' 
              className={this.state.employeeVisibility+' '}>Leave Records</button>
            </Link>
            <Link to='/LeavePolicy'>
              <button ref='LeavePolicy'> Leave Policy </button>
            </Link>
            <Link to='/leaveplan'>
              <button ref='leaveplan' className={this.state.employeeVisibility+' '}>Leave plan
              </button>
            </Link>
